...
export default function FarmPage() {
  ...
  return (
    <div className="w-full h-fit px-[40px] pt-[40px] pb-[80px] flex flex-col gap-[40px]">
      {userAddress && FARM_STATS_ITEMS.length > 0 && MARGIN_ACCOUNT_STATS_ITEMS.length > 0 && <div className={`w-full h-fit p-[24px] border-[1px] rounded-[20px] flex flex-col gap-[40px] ${isDark ? "bg-[#222222]" : "bg-[#F7F7F7]"}`}>
