...
const Spot = () => {
  ...
  return (
    ...
    >
      {/* Swap View */}
      <SpotSwapView baseSymbol={base} />

      {/* Orderbook View (commented out for now) */}
      {/* {spotMode === "orderbook" && (
        <div className={`w-full px-3 md:px-5 pt-3 md:pt-5 pb-5`}>
            ...
            <div className="flex flex-col flex-1 gap-2">
              <div className="flex flex-col gap-2">
                <div ref={tradingPairSelectorRef} className="flex gap-2 relative z-100">
                  <div className="flex-1">
                    <TradingPairInfo
                      ...
                      onOpenPairSelector={() => setIsTradingPairSelectorOpen((prev) => !prev)}
                      pair={pair}
                      market="spot"
                      icon={icon}
                      stats={spotStats}
                  ...
                  <div className={`rounded-lg p-4 flex gap-5 ${isDark ? "bg-[#222222] border border-[#333333]" : "bg-[#F7F7F7] border border-[#E2E2E2]"}`}>
                    <div className="flex flex-col gap-1">
                      <div className="text-[#A7A7A7] font-medium text-[12px] leading-[18px]">Protocol</div>
                      <Dropdown
                    ...
                    <div className="absolute top-full left-0 right-0 z-999">
                      <TradingPairSearch
                        onSelectPair={(pair) => {
                          ...
                          router.push(`/trade/${market}/${pair.base.toLowerCase()}usdc`);
                          setIsTradingPairSelectorOpen(false);
                        }}
                ...
                <div className="flex gap-2">
                  ...
                  <div className={`w-[224px] h-[541px] rounded-xl ${isDark ? "bg-[#222222] border border-[#333333]" : "bg-[#F7F7F7] border border-[#E2E2E2]"}`}>
                    <OrderBook />
                  </div>
                </div>
              </div>
