        ...
        >
          {Object.entries(repayStats).map(([key, value], index) => {
            return (
              <motion.article
                key={key}
                className={`w-full flex flex-col justify-between h-auto min-h-[100px] sm:h-[120px] rounded-[8px] border-[1px] p-3 sm:p-[16px] ${
          ...
          >
            ...
            >
              ...
              <input
                ...
                className={`w-full text-[20px] focus:border-[0px] focus:outline-none font-medium transition-transform duration-200 focus:scale-[1.01] placeholder:text-[#C7C7C7] bg-transparent ${
