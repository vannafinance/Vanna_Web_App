...
export const Positionstable = ({ onRepayClick, onOpenPositionClick }: PositionstableProps) => {
  ...
  return (
    <section className="w-full flex flex-col gap-[16px]">
      ...
      {hasMarginAccount && filteredPositions.length > 0 ? <div className="w-full overflow-x-auto no-scrollbar"><section className="rounded-[12px] min-w-[700px]">
        {/* Table headers */}
      ...
      </section></div>:<section className={`w-full h-auto min-h-[200px] sm:h-[402px] border-[1px] rounded-[8px] flex flex-col items-center justify-center p-6 ${
        isDark ? "bg-[#222222]" : "bg-[#F7F7F7]"
      }`}>
