      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={`absolute top-full right-0 mt-1 w-[267px] rounded-xl z-50 py-3 px-2 shadow-[0px_7px_15px_rgba(0,0,0,0.08),0px_28px_28px_rgba(0,0,0,0.07)] flex flex-col gap-[23px] ${isDark ? "bg-[#222222] border border-[#333333]" : "bg-[#F7F7F7]"}`}
          >
            {/* Header */}
            <h3 className={`text-[12px] leading-[18px] font-semibold ${isDark ? "text-[#FFFFFF]" : "text-[#111111]"}`}>
              Preferences
            </h3>
