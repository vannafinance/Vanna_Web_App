...
import { PriceImpactLevel } from "@/lib/types";
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-full flex items-center justify-between px-3 sm:px-4 py-2.5 sm:py-3 cursor-pointer"
      >
      ...
      <AnimatePresence>
        {isExpanded && (
          ...
          >
            <div
              className={`px-3 sm:px-4 pb-3 flex flex-col gap-2 sm:gap-2.5 border-t ${isDark ? "border-[#2A2A2A]" : "border-[#EEEEEE]"}`}
            >
