...
export const StatsCard = ({
  ...
  if (pie && percentage) {
    return (
      <div className="w-full h-fit rounded-[12px] py-[32px] px-[20px] flex  bg-[#FFFFFF] ">
        <div className="w-full h-fit flex gap-[16px] items-center ">
          ...
          <div className="w-fit h-fit flex flex-col gap-[6px]">
            <div className="w-fit h-fit flex gap-[4px] items-center text-[10px] font-medium text-[#5C5B5B]">
              {heading}
            ...
            <div className="w-full h-fit flex flex-col gap-[2px]">
              ...
              {subInfo && (
                <div className="text-[10px] font-medium text-[#5C5B5B] ">
                  {subInfo}
                </div>
              )}
            </div>
        ...
        <div className="w-full h-fit flex flex-col gap-[2px]">
          ...
          {address && (
            <div className="flex gap-[8px] items-center">
              <div className="text-[14px] font-semibold text-[]">
