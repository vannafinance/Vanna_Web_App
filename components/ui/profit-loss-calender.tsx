...
export const ProfitLossCalender = () => {
    ...
    return <div className="w-fit h-fit rounded-[24px] border-[1px] p-[32px] flex flex-col gap-[20px] bg-[#FFFFFF]">
        <div className="w-full h-fit flex justify-between items-center">
            <div className="w-full h-fit text-[24px] font-bold text-[#111111] ">
                Calendar
            </div>
            <CloseIcon className="cursor-pointer bg-[#E2E2E2] p-[12px] w-[36px] h-[36px] rounded-full" />
        </div>
        <div className="w-fit h-fit flex flex-col gap-[20px]">
            <AccountStatsGhost items={accountStats} gridCols="3" gridRows="1" />
            <div className="w-fit h-fit flex flex-col gap-[12px]">
                <div className="w-fit h-full flex gap-[20px] items-center">
                    <div >
                    ...
                    <div className="w-fit h-full flex gap-[8px]">
                        <div className="h-[38px] rounded-[8px] border-[1px] p-[10px] flex justify-center items-center">
                            <Dropdown items={monthsDropdownItems} setSelectedOption={setSelectedMonth} selectedOption={selectedMonth} classname="w-[100px] gap-[4px] text-[12px] font-medium" dropdownClassname="w-[100px]" />
                        </div>
                        <div className="h-[38px] rounded-[8px] border-[1px] p-[10px] flex justify-center items-center">
                            <Dropdown items={yearsDropdownItems} setSelectedOption={setSelectedYear} selectedOption={selectedYear} classname="w-[100px] gap-[4px] text-[12px] font-medium" dropdownClassname="w-[100px]" />
                        </div>
                    </div>
                </div>
            </div>
